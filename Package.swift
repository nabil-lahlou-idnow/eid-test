...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "IDnowEID",
            url: "https://github.com/nabil-lahlou-idnow/eid-test.git/releases/download/1.0.0/IDnowEID.xcframework.zip",
            checksum: "741340b904a774de65527940ce9269620501ee5b09304ff1670bd20fe8d39817"
        ),
        .binaryTarget(
            name: "IDnowEIDDynamic",
            url: "https://github.com/nabil-lahlou-idnow/eid-test.git/releases/download/1.0.0/IDnowEIDDynamic.xcframework.zip",
            checksum: "28bbe58dd47b9ed065ba7e70b950ca84567d8cfbf1cfdd68b4a2691a8b83750a"
        ),
        .binaryTarget(
            name: "IDnowEIDGovernikus",
            url: "https://github.com/nabil-lahlou-idnow/eid-test.git/releases/download/1.0.0/IDnowEIDGovernikus.xcframework.zip",
